...
class ipcData : public ::google::protobuf::Message {
 public:
  ...
  // required .ets.genielog.appwatcher_3.profiling.ipc.ipcAction action = 1;
  inline bool has_action() const;
  inline void clear_action();
  static const int kActionFieldNumber = 1;
  inline ::ets::genielog::appwatcher_3::profiling::ipc::ipcAction action() const;
  inline void set_action(::ets::genielog::appwatcher_3::profiling::ipc::ipcAction value);
  ...
  // @@protoc_insertion_point(class_scope:ets.genielog.appwatcher_3.profiling.core.ipc.ipcData)
 private:
...
class ipcMessage : public ::google::protobuf::Message {
 public:
  ...
  // required .ets.genielog.appwatcher_3.profiling.ipc.ipcMessage.ipcType type = 1 [default = ACTION];
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::ets::genielog::appwatcher_3::profiling::ipc::ipcMessage_ipcType type() const;
  inline void set_type(::ets::genielog::appwatcher_3::profiling::ipc::ipcMessage_ipcType value);

  // repeated .ets.genielog.appwatcher_3.profiling.ipc.ipcData data = 2;
  inline int data_size() const;
  inline void clear_data();
  static const int kDataFieldNumber = 2;
  inline const ::ets::genielog::appwatcher_3::profiling::ipc::ipcData& data(int index) const;
  inline ::ets::genielog::appwatcher_3::profiling::ipc::ipcData* mutable_data(int index);
  inline ::ets::genielog::appwatcher_3::profiling::ipc::ipcData* add_data();
  inline const ::google::protobuf::RepeatedPtrField< ::ets::genielog::appwatcher_3::profiling::ipc::ipcData >&
      data() const;
  inline ::google::protobuf::RepeatedPtrField< ::ets::genielog::appwatcher_3::profiling::ipc::ipcData >*
      mutable_data();

  // @@protoc_insertion_point(class_scope:ets.genielog.appwatcher_3.profiling.core.ipc.ipcMessage)
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::ets::genielog::appwatcher_3::profiling::ipc::ipcData > data_;
  int type_;
...
inline ::ets::genielog::appwatcher_3::profiling::ipc::ipcAction ipcData::action() const {
  return static_cast< ::ets::genielog::appwatcher_3::profiling::ipc::ipcAction >(action_);
}
inline void ipcData::set_action(::ets::genielog::appwatcher_3::profiling::ipc::ipcAction value) {
  assert(::ets::genielog::appwatcher_3::profiling::ipc::ipcAction_IsValid(value));
  set_has_action();
  action_ = value;
}
...
inline ::ets::genielog::appwatcher_3::profiling::ipc::ipcMessage_ipcType ipcMessage::type() const {
  return static_cast< ::ets::genielog::appwatcher_3::profiling::ipc::ipcMessage_ipcType >(type_);
}
inline void ipcMessage::set_type(::ets::genielog::appwatcher_3::profiling::ipc::ipcMessage_ipcType value) {
  assert(::ets::genielog::appwatcher_3::profiling::ipc::ipcMessage_ipcType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline const ::ets::genielog::appwatcher_3::profiling::ipc::ipcData& ipcMessage::data(int index) const {
  return data_.Get(index);
}
inline ::ets::genielog::appwatcher_3::profiling::ipc::ipcData* ipcMessage::mutable_data(int index) {
  return data_.Mutable(index);
}
inline ::ets::genielog::appwatcher_3::profiling::ipc::ipcData* ipcMessage::add_data() {
  return data_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::ets::genielog::appwatcher_3::profiling::ipc::ipcData >&
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ets::genielog::appwatcher_3::profiling::ipc::ipcMessage_ipcType>() {
  return ::ets::genielog::appwatcher_3::profiling::ipc::ipcMessage_ipcType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ets::genielog::appwatcher_3::profiling::ipc::ipcAction>() {
  return ::ets::genielog::appwatcher_3::profiling::ipc::ipcAction_descriptor();
}
